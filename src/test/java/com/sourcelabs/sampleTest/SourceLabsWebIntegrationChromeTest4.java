...
public class SourceLabsWebIntegrationChromeTest4 {
    ...
    public void connectToSourceLabs() throws MalformedURLException {
        ...
        sauceOptions.put(Constants.BUILD, "Test Source Integration 4");
        sauceOptions.put(Constants.TEST_NAME, "Test Source Integration 4");
