...
public class SourceLabsWebIntegrationChromeTest2 {
    ...
    public void connectToSourceLabs() throws MalformedURLException {
        ...
        sauceOptions.put(Constants.BUILD, "Test Source Integration 2");
        sauceOptions.put(Constants.TEST_NAME, "Test Source Integration 2");
